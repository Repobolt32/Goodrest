...
Use template from `E:/desktop/goodrest/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/desktop/goodrest/.gemini/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/desktop/goodrest/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
