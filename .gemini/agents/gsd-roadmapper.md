...
Reference full template: `E:/desktop/goodrest/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/desktop/goodrest/.gemini/get-shit-done/templates/state.md`.
