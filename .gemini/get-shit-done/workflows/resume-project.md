...
<required_reading>
@E:/desktop/goodrest/.gemini/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "E:/desktop/goodrest/.gemini/get-shit-done/bin/gsd-tools.cjs" init resume)
