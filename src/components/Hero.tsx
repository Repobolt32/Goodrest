      ...
      >
        <div className="max-w-4xl">
          ...
          <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div className="w-[3px] h-5 sm:h-6 bg-[#dc1e0a]" />
            <p className="text-[#dc1e0a] font-bold text-xs sm:text-sm tracking-[0.15em] uppercase">
          ...
          <p className="text-base sm:text-lg md:text-[18px] text-zinc-400 mb-8 sm:mb-12 max-w-xl leading-[1.6] font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="flex items-center gap-4 sm:gap-5 text-zinc-500 font-semibold sm:border-l border-white/10 sm:pl-6 sm:ml-4">
