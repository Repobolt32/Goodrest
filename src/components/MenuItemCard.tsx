  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        {/* Action Row */}
        <div className="mt-auto pt-4 flex flex-wrap items-center justify-between gap-3 border-t border-slate-50">
          ...
          <div className="flex items-center min-w-[100px] justify-end">
            {quantity > 0 ? (
              ...
              <button
                ...
                className="btn-strong px-6 sm:px-8 py-3 bg-primary text-white rounded-2xl text-[14px] sm:text-[15px] font-semibold shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
